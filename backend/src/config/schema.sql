...
-- ============================================================
INSERT IGNORE INTO `productos` (idproducto, titulo, descripcion, imagen, precio_preventa, precio_normal, activo, categoria, stock) VALUES
(1,  'Mbeju x unidad',              'Tradicional receta paraguaya',                   'mbeju.jpg',         7000, 8000, 1, 'COMIDA', 100),
(2,  'Pastel Mandio x unidad',       'Delicioso pastel de mandioca',                   'pastel.jpg',        7000, 8000, 1, 'COMIDA', 100),
(3,  'Pajagua Mascada x unidad',     'Clásico plato frito de carne molida y mandioca', 'pajagua.jpg',       7000, 8000, 1, 'COMIDA', 100),
(4,  'Pancho x unidad',              'Pancho en pan con aderezos',                     'pancho.jpg',        7000, 8000, 1, 'COMIDA', 100),
(5,  'Asadito de Carne con mandioca x unidad',    'Brocheta de carne a la parrilla',                'asadito_carne.jpg', 9000,10000, 1, 'COMIDA', 80),
(6,  'Asadito de Pollo con mandioca x unidad',    'Brocheta de pollo a la parrilla',                'asadito_pollo.jpg', 9000,10000, 1, 'COMIDA', 80),
(7,  'Costillita de Cerdo con mandioca x unidad', 'Brocheta de cerdo bien dorada',                  'asadito_cerdo.jpg', 9000,10000, 1, 'COMIDA', 80),
(8,  'Butifarra x unidad',           'Clásica butifarra parrillera',                   'butifarra.jpg',     9000,10000, 1, 'COMIDA', 80),
(9,  'Vori vori de pollo x plato',   'La mejor sopa del mundo',                        'vori.jpg',         30000,    0, 1, 'COMIDA', 50),
(10, 'Combo de Juegos x 10 unidades','Para divertirse en familia',                     'juegos.jpg',       50000,70000, 1, 'JUEGO',  200),
(12, 'Gaseosa 500ml',                'Productos Coca-Cola',                            'coca.jpg',         10000,10000, 1, 'BEBIDA', 150),
(13, 'Agua 500ml',                   'Productos Coca-Cola',                            'agua.jpg',          5000, 5000, 1, 'BEBIDA', 150),
(15, 'Jugo Purosol 200ml x unidad',  'Para acompañar tus comidas',                     'purosol.jpg',       5000, 5000, 1, 'BEBIDA', 100);
